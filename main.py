...
Label(sroot,text="Arya Sharma",font='Timesnewroman 40 ',bg='white',fg='grey').place(x=535,y=180)
Label(sroot,text="aryamahant001@gmail.com",font='Timesnewroman 40',bg='white',fg='grey').place(x=535,y=270)
...
def mainroot():
	...
	#-----------------------------------------------------------------
		nl = Label(b_frame,text='Made by Arya',fg='black',bg='gray91',font='msserif 8')
